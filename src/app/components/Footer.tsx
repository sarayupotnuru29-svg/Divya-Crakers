        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400 text-sm">
              <li><a href="/products" className="hover:text-red-500 transition-colors">Sound Crackers</a></li>
              <li><a href="/products" className="hover:text-red-500 transition-colors">Fancy Fireworks</a></li>
              <li><a href="/products" className="hover:text-red-500 transition-colors">Flower Pots</a></li>
              <li><a href="/products" className="hover:text-red-500 transition-colors">Rockets</a></li>
              <li><a href="/products" className="hover:text-red-500 transition-colors">Kids Special</a></li>
            </ul>
          </div>
